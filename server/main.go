//Package main generated by 'freedom new-project airdb.io/airdb/ddd'
package main

import (
	_ "airdb.io/airdb/ddd/adapter/controller" //引入输入适配器 http路由
	_ "airdb.io/airdb/ddd/adapter/repository" //引入输出适配器 repository资源库
...
func main() {
	...
	*/
	...
	//app.InstallParty("/airdb.io/airdb/ddd")
	liveness(app)
